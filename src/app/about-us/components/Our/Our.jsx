                ...
                <div className="_container">
                    ...
                    >
                        <div className={styles.col_01}>
                            <SectionLabel text={"We don’t just create; We craft experiences that work."} />
                            <SectionTitle
                            ...
                            />
                            <WhiteButton text={"Get a Quote"} type={"button"} />
                        </div>
                        ...
                        <div className={styles.col_02}>
                            <div className={styles.step}>
                                ...
                                <div className={styles.text}>We explore your needs, goals, and vision.</div>
                            </div>
                            <div className={styles.step}>
                                <h2 className={styles.label}>Step 2</h2>
                                <h3 className={styles.title}>Concept Development</h3>
                                <div className={styles.text}>Sketching, ideation, and drafting the perfect blueprint.</div>
                            </div>
                            <div className={styles.step}>
                                <h2 className={styles.label}>Step 3</h2>
                                <h3 className={styles.title}>Design & Execution</h3>
                                <div className={styles.text}>Bringing the idea to life through 3D modeling, animation, or production.</div>
                            </div>
                            <div className={styles.step}>
                                <h2 className={styles.label}>Step 4</h2>
                                <h3 className={styles.title}>Discovery & Consultation</h3>
                                <div className={styles.text}>A ready-to-use model, animation, or design tailored to your needs.</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
