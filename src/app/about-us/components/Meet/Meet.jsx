    ...
    <>
      <section className={styles.hero} ref={container}>
        <div className="_container">
          ...
          >
            <SectionTitle text={"Meet the Makers Behind Modulixo"} tag={"h2"} />
            <TextBlock
              text={
              ...
              <div className={styles.card}>
                <div className={styles.info}>
                  ...
                  <div className={styles.text}>
                    I’ve always been obsessed with structure — how things fit
                    together, how they can be improved. Designing 3D models for
                    printing is like solving a puzzle, bringing precision and
                    creativity into harmony. Every model is a challenge I love
                    to crack.
                  </div>
                </div>
              </div>
            ...
            <WhiteButton text={"Request Now"} type={"popup"} />
          </motion.div>
        </div>
      </section>
    </>
