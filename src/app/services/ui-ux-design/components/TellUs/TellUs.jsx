    ...
    <>
      <section className={styles.hero} ref={container}>
        <div className="_container">
          ...
          >
            <SectionTitle
              text={"Tell Us About Your UI/UX Design Needs"}
              tag={"h2"}
            />
            <TextBlock
              text={
                "The more details you provide, the better we can understand your vision! Please provide your project type, target audience, functionalities, and design preferences."
              }
            />
